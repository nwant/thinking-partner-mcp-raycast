...
import { readContextData, setFocus as setFocusLocal, Focus } from "./focus-client";
...
export default function Command() {
  ...
  function loadFocusData() {
    try {
      ...
      showToast({
        ...
        title: "Failed to load focus data",
  ...
  async function handleSetFocus(values: { topic: string; context: string }) {
    try {
      const newFocus = setFocusLocal(values.topic, values.context, "desktop");
